package de.bornemisza.ds.maintenance.entity;
...
public class PseudoHazelcastMap<K, V> extends HashMap<K, V> implements IMap<K, V> {
    ...
    @Override
    public <R> R aggregate(Aggregator<Map.Entry<K, V>, R> agrgtr) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public <R> R aggregate(Aggregator<Map.Entry<K, V>, R> agrgtr, Predicate<K, V> prdct) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public <R> Collection<R> project(Projection<Map.Entry<K, V>, R> prjctn) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public <R> Collection<R> project(Projection<Map.Entry<K, V>, R> prjctn, Predicate<K, V> prdct) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
