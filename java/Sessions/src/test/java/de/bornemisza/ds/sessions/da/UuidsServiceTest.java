...
import de.bornemisza.ds.sessions.da.CouchPool;
...
public class UuidsServiceTest {
    ...
    public void getUuids() {
        ...
        when(getWithCustomTimeouts.responseCode()).thenReturn(200);
        when(getWithCustomTimeouts.text()).thenReturn(getUuidResultAsJson(0)).thenReturn(getUuidResultAsJson(1)).thenReturn(getUuidResultAsJson(2)).thenReturn(getUuidResultAsJson(3));
