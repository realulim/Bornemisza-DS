...
public class PoolMaintenance {
    ...
    private static final String TIMER_NAME = "PoolMaintenanceTimer";
    ...
    PoolMaintenance(HazelcastInstance hz) {
        this.hazelcast = hz;
    }

    // Constructor for Unit Tests
    PoolMaintenance(Map<String, Integer> utilisationMap) {
        this.couchDbHostUtilisation = utilisationMap;
    }

    // Constructor for Unit Tests
    PoolMaintenance(List<String> hostQueue, HealthChecks checks) {
