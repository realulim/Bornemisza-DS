...
for FILE in top.sls files/haproxy/haproxy.cfg network.sls files/network/ifcfg-eth1 files/network/bird.conf payara.sls files/payara/payara.service files/payara/domain-config.sh files/payara/hazelcast.xml ufw.sls
do
