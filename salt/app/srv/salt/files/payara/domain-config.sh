...
{{ ASADMIN_CMD }} create-custom-resource --restype org.ektorp.CouchDbConnector --factoryclass de.bornemisza.users.da.CouchDbConnectorFactory --property url=https://$3 db=_users couchdb/Users
