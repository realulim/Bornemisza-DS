...
{{ ASADMIN_CMD }} delete-custom-resource couchdb/Sessions
{{ ASADMIN_CMD }} create-custom-resource --property service=_db._tcp.$3.:db=_session --restype de.bornemisza.couchdb.da.ConnectionPool --factoryclass de.bornemisza.couchdb.da.ConnectionPoolFactory couchdb/Sessions
